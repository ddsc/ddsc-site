...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ddsc_site_userprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('initial_period', self.gf('django.db.models.fields.CharField')(default=u'1m', max_length=16, null=True, blank=True)),
        ))
        db.send_create_signal('ddsc_site', ['UserProfile'])


    def backwards(self, orm):
        # Deleting model 'UserProfile'
        db.delete_table('ddsc_site_userprofile')
