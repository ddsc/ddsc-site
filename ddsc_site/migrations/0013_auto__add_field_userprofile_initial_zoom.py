...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.initial_zoom'
        db.add_column('ddsc_site_userprofile', 'initial_zoom',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.initial_zoom'
        db.delete_column('ddsc_site_userprofile', 'initial_zoom')
    ...
    models = {
        ...
        'ddsc_site.userprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'initial_period': ('django.db.models.fields.CharField', [], {'default': "u'1m'", 'max_length': '16', 'null': 'True', 'blank': 'True'}),
