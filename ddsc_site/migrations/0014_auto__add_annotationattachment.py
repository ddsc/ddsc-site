...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AnnotationAttachment'
        db.create_table('ddsc_site_annotationattachment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('annotation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ddsc_site.Annotation'], null=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal('ddsc_site', ['AnnotationAttachment'])


    def backwards(self, orm):
        # Deleting model 'AnnotationAttachment'
        db.delete_table('ddsc_site_annotationattachment')
    ...
    models = {
        ...
        'ddsc_site.annotation': {
            'Meta': {'object_name': 'Annotation'},
            'category': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'datetime_from': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'datetime_until': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {'null': 'True', 'blank': 'True'}),
            'picture_url': ('django.db.models.fields.TextField', [], {'max_length': '2048', 'null': 'True', 'blank': 'True'}),
            'tags': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'text': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'the_model_name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'the_model_pk': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'username': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'visibility': ('django.db.models.fields.SmallIntegerField', [], {'default': '1'})
        },
        'ddsc_site.annotationattachment': {
            'Meta': {'object_name': 'AnnotationAttachment'},
            'annotation': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ddsc_site.Annotation']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'ddsc_site.proxyhostname': {
            'Meta': {'object_name': 'ProxyHostname'},
            'hostname': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        'ddsc_site.userprofile': {
            'Meta': {'object_name': 'UserProfile'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'initial_period': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '16', 'null': 'True', 'blank': 'True'}),
            'initial_zoom': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['auth.User']", 'unique': 'True'})
        },
        'ddsc_site.workspace': {
            'Meta': {'ordering': "(u'order',)", 'object_name': 'Workspace'},
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'ddsc_site.workspaceitem': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'opacity': ('django.db.models.fields.IntegerField', [], {'default': '100'}),
            'order': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
