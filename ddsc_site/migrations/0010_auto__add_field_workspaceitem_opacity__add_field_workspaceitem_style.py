...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WorkspaceItem.opacity'
        db.add_column('ddsc_site_workspaceitem', 'opacity',
                      self.gf('django.db.models.fields.IntegerField')(default=100),
                      keep_default=False)

        # Adding field 'WorkspaceItem.style'
        db.add_column('ddsc_site_workspaceitem', 'style',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WorkspaceItem.opacity'
        db.delete_column('ddsc_site_workspaceitem', 'opacity')

        # Deleting field 'WorkspaceItem.style'
        db.delete_column('ddsc_site_workspaceitem', 'style')
