...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ddsc_site_annotation', (
            ...
            ('picture_url', self.gf('django.db.models.fields.TextField')(max_length=2048, null=True, blank=True)),
            ('the_model_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('the_model_pk', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('location', self.gf('django.contrib.gis.db.models.fields.PointField')(srid=4258, null=True, blank=True)),
            ('datetime_from', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('datetime_until', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ...
        db.send_create_signal('ddsc_site', ['Annotation'])


    def backwards(self, orm):
        # Deleting model 'Annotation'
        db.delete_table('ddsc_site_annotation')
    ...
    models = {
        ...
        'ddsc_site.annotation': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.contrib.gis.db.models.fields.PointField', [], {'srid': '4258', 'null': 'True', 'blank': 'True'}),
