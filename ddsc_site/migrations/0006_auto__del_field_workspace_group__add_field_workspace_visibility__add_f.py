...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Workspace.group'
        db.delete_column('ddsc_site_workspace', 'group_id')

        # Adding field 'Workspace.visibility'
        db.add_column('ddsc_site_workspace', 'visibility',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Workspace.creator'
        db.add_column('ddsc_site_workspace', 'creator',
        ...
        # Adding field 'Collage.visibility'
        db.add_column('ddsc_site_collage', 'visibility',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Collage.creator'
        db.add_column('ddsc_site_collage', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Workspace.group'
        db.add_column('ddsc_site_workspace', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Workspace.visibility'
        db.delete_column('ddsc_site_workspace', 'visibility')

        # Deleting field 'Workspace.creator'
        db.delete_column('ddsc_site_workspace', 'creator_id')
        ...
        # Deleting field 'Collage.visibility'
        db.delete_column('ddsc_site_collage', 'visibility')

        # Deleting field 'Collage.creator'
        db.delete_column('ddsc_site_collage', 'creator_id')
