...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Annotation.location'
        db.alter_column('ddsc_site_annotation', 'location', self.gf('django.contrib.gis.db.models.fields.PointField')(null=True))

    def backwards(self, orm):

        # Changing field 'Annotation.location'
        db.alter_column('ddsc_site_annotation', 'location', self.gf('django.contrib.gis.db.models.fields.PointField')(srid=4258, null=True))
