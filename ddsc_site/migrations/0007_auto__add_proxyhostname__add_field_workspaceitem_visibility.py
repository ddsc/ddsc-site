...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProxyHostname'
        db.create_table('ddsc_site_proxyhostname', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('hostname', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('ddsc_site', ['ProxyHostname'])

        # Adding field 'WorkspaceItem.visibility'
        db.add_column('ddsc_site_workspaceitem', 'visibility',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ProxyHostname'
        db.delete_table('ddsc_site_proxyhostname')

        # Deleting field 'WorkspaceItem.visibility'
        db.delete_column('ddsc_site_workspaceitem', 'visibility')
    ...
    models = {
        ...
        'ddsc_site.workspace': {
            'Meta': {'ordering': "(u'name',)", 'object_name': 'Workspace'},
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
