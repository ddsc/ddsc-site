...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.panner'
        db.add_column('ddsc_site_userprofile', 'panner',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.panner'
        db.delete_column('ddsc_site_userprofile', 'panner')
    ...
    models = {
        ...
        'ddsc_site.userprofile': {
            ...
            'panner': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
