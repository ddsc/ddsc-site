...
urlpatterns = patterns(
    ...
    url(r'^v1/collages/(?P<pk>\d+)/?$', views.CollageDetail.as_view(),
        name='collage-detail'),
    url(r'^v1/collages/create/?$',
        views.CollageCreate.as_view(), name='collage-create'),
    ...
    url(r'^v1/collageitems/create/?$',
        views.CollageItemCreate.as_view(), name='collageitem-create'),

    url(r'^v1/workspaces/?$',
        views.WorkspaceList.as_view(), name='workspace-list'),
    ...
    url(r'^v1/annotations/search/$',
        views.AnnotationsSearchView.as_view(), name='annotations-search'),
    url(r'^v1/annotations/detail/(?P<pk>\d+)/?$',
        views.AnnotationsDetailView.as_view(), name='annotation-detail'),
    url(r'^v1/annotations/count/$',
        views.AnnotationsCountView.as_view(), name='annotations-count'),
    url(r'^v1/annotations/create/$',
        views.AnnotationsCreateView.as_view(), name='annotations-create'),
    url(r'^v1/annotations/files/$',
        views.AnnotationsFileView.as_view(), name='annotations-files-post'),
    url(r'^v1/annotations/files/(?P<pk>\d+)/(?P<filename>.*)$',
        views.AnnotationsFileView.as_view(), name='annotations-files-get'),
